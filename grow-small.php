...
<p>But, will we break anything by doing it? In this example, probably not. But in a complete CSS file, we'd have to check the rest of the file and make sure we test it.
<p>What about maintainability? The first one wins since it's easy to see what code affects what elements. And, if you ever need to change the font size of only one of the classes, it'll be easier in the first one.
<p>Let's get organized with <a href="asset-management.php">Asset Management</a>.
</div>
