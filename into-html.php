...
<p>The point of a website is to give information. Some information is funny, such as memes or YouTube videos. Sometimes it's full of opinions and experiences, such as Tweets on Twitter or Posts on Facebook. It also can be very helpful, such as how to do mah homework.
<p>But browsers don't understand human languages very well (at least, not yet). So, us humans must tell computers how to structure the information to display. We must tell it where a paragraph starts and ends, where to put the menu, what is news and where that goes, what's a list, and so on.
