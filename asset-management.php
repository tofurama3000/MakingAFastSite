...
<p>These two are sometimes the biggest culprits of our day. We have text files, we think text is small, and so we just code and code and import libraries and code and import libraries and code some more - and then we end up with well over 4MB of just JavaScript and over 3MB of CSS, all with about a dozen file requests. We then scratch our heads and wonder, "What happend?".
<p>The truth is, there are no "free" assets or "free" resources. Everything costs space, time, and are sometimes blocking critical program aspects. This means we need to be careful. At the same time, please use assets!. I don't want to scare you out of using CSS or JavaScript, or even 3rd party libraries; they're all great, I use them a lot, and they make web development a ton easier. I just want you to think before you start loading jQuery, Angular, React, Bootstrap, and Backbone all on one page. When you're making decisions about what techniques and libraries to use on a web page, take time to answer the following questions:
<ol><li>What am I trying to accomplish?</li><li>How does _____ accomplish that?<br>(importing library/writing JS code/writing CSS code)</li><li>What resources are already available to me on that page?<br>(ex. what libraries are already being used? how is it structured? Am I able to use server-sided scripts like PHP instead?)</li><li>What other ways could I do this with what I have?<br>(ex. iframes, HTML, server-sided scripts, delayed loading, websockets)</li><li>What is the best way I could do this with what I now have and know</li></ol>
<p>Believe me when I say answering these questions will save you grief and headache. The times I failed to answer these questions first, I often made big mistakes that I could have avoided had I answered these questions. Usually the mistakes were "I included excess libraries instead of using the ones I already had".
<h2>Images</h2>
<p>You knew this was comming. Everyone on the internet seems to pound their fist and their Holy Code Bible on how space consuming and slow images are, and how you can't use large images since it will deter people who are using data plans to browse the internet. But, there are ways to make images smaller in file size and not pixel size, and there are ways to optimize images so that data people using a smartphone will load a smaller copy than desktop browsers. The first trick is to properly compress images. This is more than just another JPG vs PNG - I believe both have their place on a webpage. This is more of what settings you use when compressing, and understanding the advantages and disadvantages of each format. When in doubt, I usually will use JPG for anything without transparency, and I'll test my site against PageSpeed Insights. The reason is PageSpeed Insights will have a link that I can click to download properly compressed/minified JS, CSS, and Images. Image scaling I'll usually do on my own.
...
<p>This isn't just since people mark them as "bad", but it's also due to better alternatives being more popular and more consistent with the advent of HTML5. HTML5 allow cross-browser capabilities for complex animations, games, and 3D graphics without plugins and with less security concerns, so major browsers are using it by default. I strongly recommend looking into these technologies and setup a phase-out timeline for your current content.
<p>If you're still insitent, then answer the questions in the CSS and JavaScript section regarding the technologies youre using and look into the different ways to optimize that form of media.
<p>Comming up Next, <a href="server-tricks.php">Server Tricks</a>.
</div>
