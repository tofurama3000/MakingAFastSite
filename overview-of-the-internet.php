...
<h2>The Response</h2>
<p>Once we asked for something, we need to wait for that person to give it to us. They can say "no, you won't get that for reason <i>blah</i>", but we'll assume that they're being especially nice today and won't say "no". Let's say we ask for the home page of a website. The server that hosts the website will look at all of its files, find the right one, and send it over. 
